        ...
        >
          <div className={`pt-6 pb-4 space-y-2 ${
            ...
            <motion.a
              ...
              className="flex items-center justify-center mt-4 px-6 py-4 bg-gradient-to-r from-green-500 to-emerald-500 text-white rounded-2xl font-semibold shadow-lg"
